...
//
import { concatLink, type Ref, type Blob as PlatformBlob, type Doc, type CollaborativeDoc, collaborativeDocParse } from '@hcengineering/core'
...
export class FrontFileUploader implements FileUploader {
  constructor (private readonly frontUrl: string, private readonly token: string) {}
  ...
  public async uploadCollaborativeDoc (
    id: Ref<Doc>,
    collabId: CollaborativeDoc,
    data: Buffer
  ): Promise<Response> {
